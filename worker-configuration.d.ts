/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e14a8d03e6b48fff1140ff2f35c3fdd6)
// Runtime types generated with workerd@1.20260820.1 2024-08-21
interface __BaseEnv_Env {
	DB: D1Database;
	WIKI_QUEUE: Queue;
	Chat: DurableObjectNamespace<import("./workers/app").Chat>;
	Switchboard: DurableObjectNamespace<import("./workers/app").Switchboard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "Chat" | "Switchboard";
	}
